...
const EXTENSION_ID = 'xcxNumberbank';
 ...
 * @type {string}
 */
let extensionURL = 'https://con3office.github.io/xcx-numberbank/dist/xcxNumberbank.mjs';
...
const extensionTranslations = {
    'ja': {
        'xcxNumberbank.doIt': '[SCRIPT] を実行する'
    },
    'ja-Hira': {
        'xcxNumberbank.doIt': '[SCRIPT] をじっこうする'
    }
};
